...
Models for the taxa present in the `elements::ExamplePlot` are bundled in the "./inst/testdata/TestModels" object,
...
``` r
install.packages(file.path("path_to_file", "elements_0.7.0.tar.gz"), repos = NULL, type = "source")
```
