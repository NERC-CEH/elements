...
A tibble containing the constant taxa associated with each EUNIS
habitat.
...
A tibble with 232 rows and 5 columns.

- eunis_code:

  The EUNIS habitat code.

- eunis_name:

  The EUNIS habitat name.

- taxon_name:

  The name of the taxon as it appears in Chytrý et al (2020).
...
- perc_freq_dom:
  ...
  The percentage frequency of plots in which the species occurs with a
  cover larger than 25%.
...
species combinations and distribution maps of European habitats. Applied
