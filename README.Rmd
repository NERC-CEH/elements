...
<!-- badges: start -->
[![Generic badge](https://img.shields.io/badge/Version-0.8.0-green.svg)]()
...
<sup>1</sup>(Dengler et al., 2023), <sup>2</sup>(Midolo et al., 2023), <sup>3</sup>(Tichy et al., 2023), <sup>4</sup>(Marchi et al., 2020)
</p>

## Models

At present there are `r length(elements::ModelledTaxaCodes)` ENMs currently included in `elements`.
